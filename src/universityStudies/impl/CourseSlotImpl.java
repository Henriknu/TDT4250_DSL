 ...
 * </p>
 * <ul>
 *   <li>{@link universityStudies.impl.CourseSlotImpl#getCourse <em>Course</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CourseSlotImpl extends MinimalEObjectImpl.Container implements CourseSlot {
	...
	protected EClass eStaticClass() {
		return UniversityStudiesPackage.Literals.COURSE_SLOT;
	}
		...
		if (course != null && course.eIsProxy()) {
			...
			if (course != oldCourse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UniversityStudiesPackage.COURSE_SLOT__COURSE, oldCourse, course));
			}
		}
		return course;
	}
	...
	public void setCourse(Course newCourse) {
		...
		course = newCourse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniversityStudiesPackage.COURSE_SLOT__COURSE, oldCourse, course));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UniversityStudiesPackage.COURSE_SLOT__COURSE:
